...
&nbsp;            <span class="red"> </span></td>
        ...
        <tr valign="top" bgcolor="#efefef">
          ...
          <td>
            ...
            <? }else{ ?>
			<input name="chgPassword" type="button" id="chgPassword" value="Change Password"  onclick="popupwindow('/user_management/chgpwd/<?=$row['StatusID']?>', 'User Change Password', 320, 240)" >
			<? } ?>			</td>
          <td>&nbsp;</td>
          <td>Phone 2 </td>
          <td width="5">:</td>
