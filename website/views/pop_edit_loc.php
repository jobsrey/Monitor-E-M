...
self.close();
			...
			<table width="100%"  height="100%" border="0" cellpadding="8" cellspacing="1"> 
              <tr bgcolor="#5A91B1"> 
				 ...
				 <? }else{ ?>
				    <span class="red size18"><?=$strPop?> Location done...</span><br><br>
                    <span class=""><a onclick="parent_url('/master_data/edit_data/<?=$editID;?>/terminal_location')" href="#"><u>Close -> Exit</u></a></span>
				  <? } ?> 
                  <p>&nbsp;</p>
				  </td> 
                </tr> 
                   ...
                   <select name="chgpar_location" id="chgpar_location">
                    ...
                    <?  
						...
						if($locData[$k]['loc_cat']!="venue"){
							...
							if($cur_cat=="venue"&&$locData[$k]['loc_cat']=="area") 		$show=1;
							elseif($cur_cat=="area"&&$locData[$k]['loc_cat']=="city")  		$show=1;
							elseif($cur_cat=="city"&&$locData[$k]['loc_cat']=="province")  	$show=1;
							elseif( $cur_cat=="province" && $locData[$k]['loc_cat']=="country") $show=1;
							else $show=0;    
