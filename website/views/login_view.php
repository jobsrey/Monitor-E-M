<html>
<head>
<title>Login Mandiri Kiosk Web Administration by LunariKiosk.com</title>  
<meta charset="UTF-8">
...
<tr><td align="center" valign="middle">
	<div class="frame">
    	<div class="left" align="left">
        	<p><strong>&nbsp;&nbsp;&nbsp;Welcome to<br>
        	  <img src="/asset/images/logo.png" width="180" height="43"><br>
        	  &nbsp;&nbsp;&nbsp;Web Administrator. </strong><br>
       	      <br>
       	      <strong>&nbsp;&nbsp;<span class="style1">&nbsp;Use a valid username and &nbsp;&nbsp;&nbsp;password to gain access to<br>
&nbsp;&nbsp;       	      the administration console
             </span></strong><span class="style1">.</span></p>
        	<p>&nbsp;</p>
        	<p>&nbsp; </p>
    	</div>
        <div class="right" align="left">
            ...
            <br> 
            <? } ?>
		<form method="post" action="<?=base_url()?><?=index_page();?>/login/signin">
  			<div><strong>Username</strong> / Email Address</div>
            <div><input name="username" type="text" class="form" style="font-size:16px" autocomplete="off" >
            </div>
            <div style="padding-top:5px;"><strong>Password</strong></div> 
            <div><input name="password" type="password" class="form" style="font-size:16px" autocomplete="off" >
            </div> 
