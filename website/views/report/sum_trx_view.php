    	...
    	<div id="dspdata"> 
         ...
         <table id="tbl_data" class="tbldetail2 tdline" width="" border="0" cellpadding="5" cellspacing="0">
		 		<thead bgcolor="#efefef">
					    ...
					    <td colspan="5" align="center" bgcolor="#B3DFF2"><strong>Top Up-Mandiri</strong></td>
					  ...
					  <tr bgcolor="#efefef" align="center">
					    ...
					    <td style="border-bottom:2px solid #006699; background-color: #B3DFF2;">20k</td>
					    <td style="border-bottom:2px solid #006699; background-color: #B3DFF2;">50k</td>
					    <td style="border-bottom:2px solid #006699; background-color: #B3DFF2;">100k</td>
					...
					foreach($rowTrxSum as $k => $v){ 
						...
						foreach($v as $k2 => $v2){ //echo "<br>$k => $k2 => $v2";  
							...
							$total_tup_item20  += $rowTrxSum[$tid][$dt]['price_item20']; 
					  ...
					  <tr > 
					    <td align="right"><?=$x;?>.&nbsp;<input name="id" type="hidden" value="1" /></td> 
								...
								<td align="center" bgcolor="#E9F7FD"><?=$rowTrxSum[$tid][$dt]['price_item20'];?></td> 
		  			...
		  			<tr class="tdtotal">  
					    ...
					    <td class=" " align="center" bgcolor="#99C4D8" ><?=$total_tup_item20;?></td> 
