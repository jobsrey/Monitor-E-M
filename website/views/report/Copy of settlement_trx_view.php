       	  ...
       	  <table class="tbldetail2 tdline" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
				...
				<thead bgcolor="#efefef">
					<tr >
                        ...
                        <td rowspan="2" align="center" style="border-bottom:2px solid #006699;" nowrap="nowrap">
                        	<div class="" style="display:inline-block;" >
                            	<a href="<?=$qs;?>" style="padding:0 3px 0 0;float:left;display:inline-block;font-size:12px;text-decoration:underline; font-weight:bold;color:#333333">Date Time</a>
                                <span class="float_l <? if($sort_date=="asc") echo "s_asc_r"; elseif($sort_date=="desc") echo "s_desc_r"; ?>"></span>
                            </div></td>  
			...
			?>
					<tr bgcolor=" <? if($row['kdprd']!='tbk') echo"#ffffff"; else echo "#996633";?>" > 
		  			...
		  			<tr>   
						...
						<td class="tdtotal" align="right"><?=$total_amount;?></td>
						<td class="tdtotal" align="center"><?=($tot_quaCrd+$tot_qua50+$tot_qua100); //=$total_item;?></td> 
