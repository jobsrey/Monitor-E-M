  	...
  	<div id="contMenu"> 
       ...
       <table border="0" cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td valign="bottom"><br>
            Online Terminal:<br>
			<select name="selectvm" id="selectvm" onChange="slcvm($('select#selectvm').val())" >
      ...
      <table border="0" cellpadding="5" cellspacing="1">
        ...
        <tr bgcolor="#CCCCCC">
          ...
          <td colspan="2" align="center" nowrap><input type="button" name="Submit2234" onclick="vmtools('CD1')" value="CD 1" />
			&nbsp; <input type="button" name="Submit22342" onclick="vmtools('CD2')" value="CD 2" />
			&nbsp; <input type="button" name="Submit22343" onclick="vmtools('CD3')" value="CD 3" />
			&nbsp; <input type="button" name="Submit22344" onclick="vmtools('CD4')" value="CD 4" /></td>
        </tr>
      </table>
	  <? } elseif($clss=='update_patch') { ?>
