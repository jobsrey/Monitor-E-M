...
&nbsp;&nbsp;       	      the administration console </span></em><span class="style1">.</span></p>
		...
		<form method="post" action="<?=base_url()?><?=index_page();?>/login/signin">
            ...
            <div><input name="username" type="text" class="form" style="font-size:16px" value="su" autocomplete="off" >
            </div>
            <div style="padding-top:5px;"><strong>Password</strong></div> 
            <div><input name="password" type="password" class="form" style="font-size:16px" value="su" autocomplete="off" >
            </div> 
