...
<div class="container">
    ...
    <div class="linelbl"></div> 
      ...
      <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#FFFFFF">
        ...
        <tr  bgcolor="#FFB3B3">
          <td  nowrap="nowrap" bgcolor="#FFB3B3">AE-Officer-Name</td>
          <td  bgcolor="#FFB3B3"><input name="TFCMerchantAE" type="text" id="TFCMerchantAE" value="<?=$row['TFCMerchantAE'];?>" size="28" autocomplete="off" />
            <br /><span class="red"> *Nama Marketer/AE yg mendapatkan merchant  (Refferal).</span></td>
        </tr>
        <tr>
          <td bgcolor="#C6E7FF"> Merchant Name </td>
          <td bgcolor="#C6E7FF"> <em>
            <input name="TFCMerchantName" type="text" id="TFCMerchantName" value="<?=$row['TFCMerchantName'];?>" size="35" autocomplete="off" />
          </em></td>
          <td width="120" nowrap="nowrap" bgcolor="#FFFFCC">Register Date<br /></td>
          <td bgcolor="#FFFFCC"> 
        ...
        <tr  bgcolor="#efefef">
          ...
          <td bgcolor="#FFFFCC"><span class="red size16">REGISTER</span></td>
        </tr>
        
        <tr bgcolor="#FFFFFF">
          <td valign="middle" nowrap="nowrap" bgcolor="#ffffff">&nbsp; </td>
          <td valign="top" bgcolor="#ffffff"><span class="red">*If NOT on list, please contact<strong> TFC-Admin-Pusat</strong> to <br />
            add NEW category. Category can update with new category later.<br />
          </span></td>
          <td valign="middle" bgcolor="#ffffff"> Accepted Cards</td>
          <td bgcolor="#ffffff"><span class="red size16">
            <?
			$tbl = "md_tfc_card";
        ...
        <tr valign="top" bgcolor="#efefef">
          <td colspan="4" valign="middle" nowrap="nowrap" bgcolor="#efefef">&nbsp;</td>
          </tr>
      </table> 
      ...
      <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#FFFFFF">
        ...
        <tr  bgcolor="#FFB3B3">
          ...
          <td  bgcolor="#FFB3B3"><input name="TFCMerchantAE" type="text" id="TFCMerchantAE" value="<?=$row['TFCMerchantAE'];?>" size="28" autocomplete="off" />
            <br />
            <span class="red">*Nama Marketer/AE yg mendapatkan merchant  (Refferal).</span></td>
        </tr>
        <tr>
          <td bgcolor="#C6E7FF">Merchant ID <span class="red"></span></td>
          <td bgcolor="#C6E7FF"><input <? echo ' disabled="disabled" '; ?> name="TFCMerchantID" type="text" id="TFCMerchantID" value="<?=$row['TFCMerchantID'];?>" size="10" autocomplete="off" />
            <span class="red">*generate ID on merchant validation</span></td>
          <td width="120" nowrap="nowrap" bgcolor="#efefef">Register Date<br /></td>
          <td bgcolor="#efefef"><?=$row['TFCMerchantRegisterDate'];?></td>
        </tr>
        <tr  bgcolor="#efefef">
          <td bgcolor="#C6E7FF">Merchant Name </td>
          ...
          <td nowrap="nowrap" bgcolor="#ffffff"> Valid Date <span class="red">*</span><span class="red">*</span></td>
          <td bgcolor="#ffffff"><input disabled="disabled" name="TFCMerchantValidDateBegin" type="text" id="datepicker2" value="<?=$row['TFCMerchantValidDateBegin'];?>" size="7" maxlength="12" />
            thru 
              <input disabled="disabled" name="TFCMerchantValidDateEnd" type="text" id="datepicker3" value="<?=$row['TFCMerchantValidDateEnd'];?>" size="7" maxlength="12" />
              <span class="red"><br />
              </span></td>
        </tr>
        
        <tr bgcolor="#FFFFFF">
          <td valign="top" nowrap="nowrap" bgcolor="#E8FFD9">Merchant Logo <span class="red">***</span>
          <? if($row['TFCMerchantLogo']){ ?>
          	<br />
          	<input type="submit" name="delimage" id="delimage" value="DELETE-LOGO" style="margin-top:5px"/>
          <? } ?>          </td>
          <td valign="top" bgcolor="#E8FFD9">
          <input name="img_logo" type="hidden" id="img_logo" value="<?=$row['TFCMerchantLogo'];?>" />
          <? if($row['TFCMerchantLogo']){ ?>
          	<img src="<?=substr($row['TFCMerchantLogo'],1,strlen($row['TFCMerchantLogo']));?>" width="80"  />  
          <? }else{ ?>  
             <input type="file" name="uploadMerchantLogo" id="uploadMerchantLogo" />
          <? } ?>          </td>
          <td valign="top" bgcolor="#FFFFCC">Merchant Status<span class="red"> *</span><span class="red">*</span></td>
          <td valign="top" bgcolor="#FFFFCC"><span class="red size16"><?=$row['TFCMerchantStatus'];?> </span>    </td>
        </tr>
        <tr bgcolor="#efefef">
          <td valign="top" bgcolor="#E8FFD9">Merchant Photo  <span class="red">***</span>
          <? if($row['TFCMerchantPhoto']){ ?>
          	<br />
          	<input type="submit" name="delimage" id="delimage" value="DELETE-PHOTO" style="margin-top:5px"/>
          	<? } ?>          </td>
          <td valign="top" bgcolor="#E8FFD9">
          <input name="img_photo" type="hidden" id="img_photo" value="<?=$row['TFCMerchantPhoto'];?>" />
		  <? if($row['TFCMerchantPhoto']){ ?>
          	<img src="<?=substr($row['TFCMerchantPhoto'],1,strlen($row['TFCMerchantPhoto']));?>" width="120"  />  
          <? }else{ ?>  
             <input type="file" name="uploadMerchantPhoto" id="uploadMerchantPhoto" />
          <? } ?>            </td>
          <td valign="top" bgcolor="#ffffff">Accepted Cards</td>
          ...
          <td colspan="4" valign="middle" nowrap="nowrap" bgcolor="#efefef">
          <div class="red" style="padding:3px 5px"> &nbsp; **) Setting this on <strong>Merchant Validation</strong> menu.</div>
          <div class="red" style="padding:3px 5px"> ***) UPLOAD file =&gt; file-<strong>ext</strong>ension : <strong>gif</strong>/<strong>jpg</strong>/<strong>png</strong> ; size-max : <strong>1000</strong> Kb; <strong>w</strong> x<strong> h</strong> max : <strong>1024</strong> x <strong>768</strong> pixel; <br />
  &nbsp; &nbsp; &nbsp; &nbsp; Image LOGO <strong>recomended</strong> size-max, <strong>w</strong> x<strong> h </strong>: <strong>300</strong> x <strong>300</strong> pixel.<br />
  &nbsp; &nbsp; &nbsp; &nbsp; To <strong>change</strong>/re-upload image, <strong>DELETE</strong> existing uploaded images first.</div>
          </span></td>
          </tr>
        <tr valign="top" bgcolor="#efefef">
        ...
        <tr valign="top" bgcolor="#efefef">
          ...
          <td colspan="3" valign="middle" bgcolor="#efefef">
            <?
			$tbl = "md_merchant_category";
			$slc_key = "TFCMerchantCategoryID";
			$rowData = $this->allmodel->getTableWhere($tbl);
        ...
        <tr valign="top">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="0">
            <? 
			$n = 0;
			foreach ($rowProduct as $key => $RowP) {    //echo "<br>".$RowP['merchant_type']; ?>
            <tr>
              ...
              <td><?
				...
				$rowData = $this->allmodel->getTableWhere($tbl);  
				?><select name="merchant_type[<?=$RowP['id'];?>]" id="merchant_type[<?=$RowP['id'];?>]" >
                <option value="-1"></option>
				<? foreach($rowData as $RowT){  ?>
                <option value="<?=$RowT['id'];?>" <? if($RowP['merchant_type']==$RowT['id']) echo 'selected="selected"';?> ><?=$RowT['name'];?></option>
                <? } ?>
                </select >              </td>
              <td>Amount-Value: Rp.<span class="red">*</span></td>
              <td><input name="product_credit[<?=$RowP['id'];?>]" type="text" id="product_credit[<?=$RowP['id'];?>]" value="<?=$RowP['product_credit'];?>" size="12" maxlength="12"  autocomplete="off"/></td>
              <td>Term</td>
           ...
           <? $n++;
            ...
            <pre><span class="red">* Jika Type = "FREE/GRATIS" => Amount-Value = XXXXXX (rupiah, angka saja) - don't use any chars , or .
  Jika Type = "DISCOUNT"    => Amount-Value = XX% (persentase diskon) - dengan symbol % tanpa spasi.</span></pre></td>
          </tr>
        <tr valign="top">
        ...
        <tr valign="top">
          <td valign="middle" bgcolor="#E8FFD9">Map-Photo <span class="red">***</span>
          <? if($row['TFCMerchantMapPhoto']){ ?>
          	<br />
          	<input type="submit" name="delimage" id="delimage" value="DELETE-MAPPHOTO" style="margin-top:5px"/>
          <? } ?>          </td>
          <td colspan="3" valign="middle" bgcolor="#E8FFD9"> 
          <input name="img_mapphoto" type="hidden" id="img_mapphoto" value="<?=$row['TFCMerchantMapPhoto'];?>" />
          <? if($row['TFCMerchantMapPhoto']){ ?>
          	<img src="<?=substr($row['TFCMerchantMapPhoto'],1,strlen($row['TFCMerchantMapPhoto']));?>" width="120"  />  
          <? }else{ ?>  
             <input type="file" name="uploadMapPhoto" id="uploadMapPhoto" />
          <? } ?>          </td>
          </tr>
          ...
          <td colspan="4" bgcolor="#FFFFFF"><span class="red">*) must be filled out before submitting the form</span></td>
            ...
            <table width="100%" border="0" cellpadding="8" cellspacing="0" bgcolor="#999">
              <tr align="right" >
                ...
                <td align="center" ><? if($row['StatusID']==2){ ?>
                  User Status :
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                  <? } ?>
                  <input type="submit" name="Submit" value="UPDATE CHANGES" style="cursor:pointer" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              </tr>
      </table>            
       </form> 
