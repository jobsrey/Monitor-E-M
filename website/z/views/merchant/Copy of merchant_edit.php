    ...
    <div class="linelbl"></div> 
      ...
      <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#FFFFFF">
        ...
        <tr  bgcolor="#FFB3B3">
          ...
          <td  bgcolor="#FFB3B3"><input name="TFCAEOfficer" type="text" id="TFCAEOfficer" value="<?=$row['TFCAEOfficer'];?>" size="16" autocomplete="off" /></td>
        </tr>
        <tr>
          <td bgcolor="#C6E7FF">Merchant ID</td>
          <td bgcolor="#C6E7FF"><input name="TFCMerchantID" type="text" id="TFCMerchantID" value="<?=$row['TFCMerchantID'];?>" size="10" autocomplete="off" /></td>
          <td width="120" nowrap="nowrap" bgcolor="#efefef">Register Date<br /></td>
          <td bgcolor="#efefef"><input name="TFCRegisterDate" type="text" id="datepicker" value="<?=$row['TFCRegisterDate'];?>" size="7" maxlength="18" />
            *yyyy-mm-dd</td>
        </tr>
        <tr  bgcolor="#efefef">
          ...
          <td bgcolor="#ffffff"><input name="TFCValidDateBegin" type="text" id="datepicker2" value="<?=$row['TFCValidDateBegin'];?>" size="7" maxlength="12" />
            until
            <input name="TFCValidDateEnd" type="text" id="datepicker3" value="<?=$row['TFCValidDateEnd'];?>" size="7" maxlength="12" /></td>
        </tr>
        
        <tr bgcolor="#FFFFFF">
          <td valign="middle" nowrap="nowrap" bgcolor="#E8FFD9">Merchant Logo</td>
          <td valign="top" bgcolor="#E8FFD9"><input type="file" name="uploadMerchantLogo" id="uploadMerchantLogo" />            </td>
          <td valign="middle" bgcolor="#FFFFCC">Merchant Status</td>
          <td bgcolor="#FFFFCC"><span class="red size16">
            <?=$row['TFCMerchantStatus'];?>
          </span> 
        ...
        <tr bgcolor="#efefef">
          ...
          <td bgcolor="#E8FFD9"><input type="file" name="uploadMerchantPhoto" id="uploadMerchantPhoto" /></td>
          <td bgcolor="#ffffff">Accepted Cards</td>
          <td bgcolor="#ffffff"><?
			$tbl = "md_tfc_card";
			$slc_key = "TFCAcceptCardID";
        ...
        <tr valign="top">
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="0">
            <? 
			$n = 0;
			foreach ($rowProduct as $key => $RowP) { //echo "<br>$key => $key2 => $value2"; ?> 
            <tr>
              ...
              <td nowrap="nowrap">/</td>
              <td nowrap="nowrap"><select name="product_periode[<?=$RowP['id'];?>]" id="product_periode[<?=$RowP['id'];?>]" <?//=$disableGroup;?> >
                <option value="-1"></option>
              ...
              <td nowrap="nowrap">=&gt;</td>
              <td nowrap="nowrap"><input name="product_credit[<?=$RowP['id'];?>]" type="text" id="product_credit[<?=$RowP['id'];?>]" value="<?=$RowP['product_credit'];?>" size="1" maxlength="6"  autocomplete="off"/></td>
              <td></td>
              <td>Term</td>
        ...
        <tr valign="top">
          ...
          <td bgcolor="#efefef"><textarea name="TFCMerchantOpen" cols="32" rows="3" autocomplete="off">Senin-Jumat: 09.00 - 21.00
Sabtu-Minggu:09.00 - 17.00
Hari raya tetap buka seperti biasa.</textarea></td>
        ...
        <tr valign="top">
          <td valign="top" bgcolor="#ffffff">Merchant <br />
            Address</td>
          <td valign="top" bgcolor="#ffffff"><textarea name="Address" cols="32" rows="4" autocomplete="off"><?=$row['Address'];?></textarea>
            <br />
            <br />
            <input name="WorkLocationID" type="" id="WorkLocationID" value="<?=$row['WorkLocationID'];?>" size="3" /></td>
        ...
        <tr valign="top">
          ...
          <td valign="middle" bgcolor="#efefef"><input name="TFCPhone" type="text" id="TFCPhone" value="<?=$row['TFCPhone'];?>" size="35" autocomplete="off" /></td>
          <td valign="middle" bgcolor="#efefef">Merchant Email</td>
          <td valign="middle" bgcolor="#efefef"><input name="TFCEmail" type="text" id="TFCEmail" value="<?=$row['TFCEmail'];?>" size="35" autocomplete="off" /></td>
        </tr>
        <tr valign="top">
          <td valign="middle" bgcolor="#ffffff">Merchant Fax</td>
          <td valign="middle" bgcolor="#ffffff"><input name="TFCFax" type="text" id="TFCFax" value="<?=$row['TFCFax'];?>" size="35" autocomplete="off" /></td>
          <td valign="middle" bgcolor="#ffffff"> Merchant Website</td>
          <td valign="middle" bgcolor="#ffffff"><input name="TFCWebsite" type="text" id="TFCWebsite" value="<?=$row['TFCWebsite'];?>" size="35" autocomplete="off" />            </td>
        </tr>
        ...
        <tr >
          ...
          <td valign="top"><label></label>
            ...
            <?=$rowRes['name']?>                </td>
                <td><input name="ContactMediaData[<?=$rowRes['id'];?>]" type="text" value="<?=$ChkVal;?>" size="11" autocomplete="off" /></td>
              </tr>
              <? } ?>
            </table> </td>
          <td colspan="2" valign="top"><em>Social Media Online :</em><br />
              <table border="0" cellpadding="4" cellspacing="0">
		  	  ...
		  	  ?>
                <tr>
                  <td><input name="SocialMediaID[<?=$rowRes['id'];?>]2" type="checkbox" id="SocialMediaID[<?=$rowRes['id'];?>]2" <?=$Chkstr;?> />
                      <?=$rowRes['name']?>                  </td>
                  <td><input name="SocialMediaData[<?=$rowRes['id'];?>]2" type="text" value="<?=$ChkVal;?>" size="35" autocomplete="off" /></td>
                </tr>
                <? } ?>
            </table></td>
        </tr>
        ...
        <tr >
          ...
          <td colspan="3" bgcolor="#efefef"><input name="TFCMapGeo" id="TFCMapGeo" type="text" value="<?=$row['TFCMapGeo'];?>" size="35" autocomplete="off" />
            <em>*google-map standard format</em></td>
          </tr>
        <tr valign="top">
          <td valign="middle">Map-Label</td>
          <td valign="middle"><input name="TFCMapLabel" type="text" id="TFCMapLabel" value="<?=$row['TFCMapLabel'];?>" size="35" autocomplete="off" /></td>
          <td valign="middle">Map-Description</td>
          <td valign="middle"><textarea name="TFCMapDesc" cols="35" rows="1" id="TFCMapDesc" autocomplete="off"><?=$row['TFCMapDesc'];?></textarea></td>
        </tr>
        <tr valign="top">
          <td valign="middle" bgcolor="#E8FFD9">Map-Photo</td>
          <td colspan="3" valign="middle" bgcolor="#E8FFD9"><input type="file" name="uploadMapPhoto" id="uploadMapPhoto" /></td>
          </tr>
        ...
        <tr valign="top">
          ...
          <td colspan="3" valign="middle"><div id="slc_position" style="display:inline-block;">
            ...
               
<input class="bt_formreg" onclick="popupwindow('/master_data/edit_data/0/position/1/2','Add Position',330,205)" name="add_position" id="add_position" value="add" type="button" /> 
&nbsp; *exp: owner/manager/head-division</td>
          </tr>
        <tr valign="top">
          ...
          <td valign="middle" bgcolor="#efefef"><?
			...
			$rowData = $this->allmodel->getTableWhere($tbl);
		  	?>
            <select name="<?=$slc_key;?>4" id="<?=$slc_key;?>5" >
              <option value="-1"></option>
              <? foreach($rowData as $rowRes){  ?>
              <option value="<?=$rowRes['id'];?>" <? if($row[$slc_key]==$rowRes['id']) echo 'selected="selected"';?> >
              <?=$rowRes['name']; ?>
            ...
            <input class="bt_formreg11" onclick="popupwindow('/master_data/edit_data/0/religion/1/2','Add Religion',330,205)" name="add_religion2" id="add_religion2" value="add" type="button" /></td>
        </tr>
        <tr valign="top" bgcolor="#efefef">
          ...
          <td valign="middle" bgcolor="#FFFFFF"><?
			...
			$rowData = $this->allmodel->getTableWhere($tbl);
		  	?>
              <select name="<?=$slc_key;?>3" id="<?=$slc_key;?>4" >
                <option value="-1"></option>
                <? foreach($rowData as $rowRes){  ?>
                <option value="<?=$rowRes['id'];?>" <? if($row[$slc_key]==$rowRes['id']) echo 'selected="selected"';?> >
                <?=$rowRes['name']; ?>
              ...
              <input class="bt_formreg1" onclick="popupwindow('/master_data/edit_data/0/religion/1/2','Add Religion',330,205)" name="add_religion" id="add_religion" value="add" type="button" /></td>
        </tr>
