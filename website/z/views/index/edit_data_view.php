             ...
             <tr>
              <td bgcolor="#999999">
                ...
                <table border="0" cellpadding="6" cellspacing="1" >
                	...
                	<tr bgcolor="#CCCCCC">
                  		<td colspan="2"><strong><?=$tablemod." ".$tablelbl?></strong> 
                        <? //if($TABLE!='user_group_table'){ ?>
                ...
                <? if($TABLE=='user_group_table'){ ?>  
                    <tr valign="top" bgcolor="#FFFFFF">
                      <td>GroupID</td>
                      <td nowrap="nowrap"> <input name="gid" type=" " id="gid" value="<?=$id;?>" size="1" /> 
                      *kode telepon tanpa "0" didepan.</td> 
                    </tr> 
                <? } ?>  
        		<?
                ...
                <tr align="right" valign="top" bgcolor="#cccccc">
                  <td colspan="2">
					  ...
					  <? } elseif($TABLE!='md_location'){ //--- tadinya $TABLE!='md_location'   ?>
