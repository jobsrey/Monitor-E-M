          ...
          <table class="tbldetail2 tdline" width="" border="0" cellpadding="5" cellspacing="0">
			...
			*/
			...
			?>
       	  ...
       	  <table class="tbldetail2 tdline" width="" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
				...
				<thead bgcolor="#efefef">
					<tr >
				        ...
				        <td align="right" style="border-bottom:2px solid #006699;">trx_num</td>
				        <td align="right" style="border-bottom:2px solid #006699;">slot</td>
					</tr>
				</thead>
				<tbody>
                    <? 
					...
					foreach($rowTrx as $row){
						...
						$clr_tbk = 'style="color:#ffffff"';
						
			?>
					<tr bgcolor=" <? if($row['kdprd']!='tbk') echo"#ffffff"; else echo "#993300";?>"> 
					  <td align="right"><? if($row['kdprd']!='tbk') echo $x."."; else $x=$x-1; ?>&nbsp;<input name="id" type="hidden" value="1" /></td> 
						...
						<td <? if($row['kdprd']=='tbk') echo $clr_tbk;?> ><? if($row['kdprd']=='tbk') echo "Total : "; else echo $prd;?></td>
						<td <? if($row['kdprd']=='tbk') echo $clr_tbk;?> align="center"><? if($row['kdprd']=='tbk') echo $row['totaltrx'];  else echo $row['jmlbeli'];?></td>
						<td <? if($row['kdprd']=='tbk') echo $clr_tbk;?> align="right"><? if($row['kdprd']=='tbk')  echo $row['uangmasuk']; else echo number_format($tot,0,',','.');?></td>
                        <td align="center"><?=$row['trx_num'];?></td>
