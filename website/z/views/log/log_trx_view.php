	...
	<!-- pageContent -->    
  	<div id="contMenu"> 
        ...
        <div id="form-filter">
            ...
            <input type="hidden" name="callfunc" id="callfunc" value="<?=$callfunc;?>"/>
            <table> 
              <tr>
                <td><span class="ibDtPict float_l">Terminal</span>-ID</td>
                <td>:</td>
                <td><div id="tproductlist" class="ibDtPict float_l" ><span id="vmlist"><?=$listmenu_vm;?></span></div></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td><span class="ibDtPict float_l">Transaction-</span>Type</td>
                <td>:</td>
                <td><div class="ibDtPict">&nbsp;&nbsp;</div></td>
                <td>&nbsp;</td> 
              </tr>
              <tr>
                <td>Date Time <span class="ibDtPict">
                <?
              ...
              <select name="tm2" id="tm2">
                ...
                <td><input name="sort_date" type="hidden" id="sort_date" value="<?=$sort_date?>"><span class="float_r arial12" style="padding-left:20px; display:inline-block">
