...
class Reporting extends Controller { 
	...
	function mainvars($ci_func='',$status_id=1,$limit=10){  
	 ...
	 function summary_kiosk_transaction($dt1="",$dt2="",$owner_id=0,$terminal_id=0,$product_id=0,$item_id=0){  
		...
		*/
		...
		$this->load->view('report/sum_trx_view2',$data);  
 
	}
 
	 function summary_kiosk_transactionx($dtm1="",$dtm2="",$owner_id=0,$terminal_id=0,$product_id=0,$item_id=0){  
 ...
 /*	 
	function summary_transaction($dt1="",$dt2="",$owner_id=0,$terminal_id=0,$product_id=0,$item_id=0){  
		...
		$q = "Select * From `topup_mandiri` Where $strTRXID $strTID $strDT Order By id Desc ";
		...
		$this->load->view('report/summary_trx_view',$data);  
