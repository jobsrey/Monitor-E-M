...
class Reporting extends Controller { 
 ...
 //exit;
		...
		*/ 
		...
		$tup_tot_item10 = $tup_tot_item20 = $tup_tot_item50 = $tup_tot_item100 = 0;
		...
		foreach($arr_summary as $k => $v){  
			foreach($v as $k2 => $v2){ 
				...
				$tot_prc10 = $tot_prc20 = $tot_prc50 = $tot_prc100 = 0; 
				...
				foreach($v2 as $k3 => $v3){  
						...
						foreach($v3 as $k4 => $v4){ 
							...
							if($k4=='payment'){    //echo "<br>".count($v4); 
								...
								foreach($v4 as $k5 => $v5){   
									...
									//echo "<br>".$v5;
									if($v5==10000) { $tot_prc10++;	$tup_tot_item10++; }
									if($v5==20000) { $tot_prc20++;	$tup_tot_item20++; }
					...
					$arr_summary_trx2[$k][$k2]['price_item10'] 	= $tot_prc10; 
					$arr_summary_trx2[$k][$k2]['price_item20'] 	= $tot_prc20; 
