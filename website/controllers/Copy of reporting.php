...
class Reporting extends Controller { 
 ...
 function card_transaction($dt1="",$dt2="",$owner_id=0,$terminal_id=0,$product_id=0,$item_id=0){  
		...
		$data['reportfunc'] = $reportfunc = 'card_transaction'; //-- form filter data, submit to this function
